...
export const FULL_SEUNGBUSHIK_MATCHES: Match[] = [
  // 1번 경기 (KBO 야구)
  {
    ...
    status: 'SCHEDULED', matchTime: '08.28(목) 18:30', closingTime: '08.28(목) 18:20', venue: '대구 삼성 라이온즈 파크',
  ...
  // 2번 경기 (EPL 축구)
  {
    ...
    status: 'SCHEDULED', matchTime: '08.28(목) 22:30', closingTime: '08.28(목) 22:20', venue: '올드 트래포드',
  ...
  // 3번 경기 (KBO 야구)
  {
    ...
    status: 'SCHEDULED', matchTime: '08.28(목) 18:30', closingTime: '08.28(목) 18:20', venue: '잠실 야구장',
  ...
  // 4번 경기 (라리가 축구)
  {
    ...
    status: 'SCHEDULED', matchTime: '08.29(금) 04:00', closingTime: '08.29(금) 03:50', venue: '산티아고 베르나베우',
  ...
  // 5번 경기 (MLB 야구)
  {
    ...
    status: 'SCHEDULED', matchTime: '08.29(금) 11:10', closingTime: '08.29(금) 11:00', venue: '다저 스타디움',
  ...
  // 6번~10번 경기 (K리그 / EPL / NBA / KBL 추가)
  {
    ...
    status: 'SCHEDULED', matchTime: '08.29(금) 19:30', closingTime: '08.29(금) 19:20', venue: '전주월드컵경기장',
  ...
  },
  {
    ...
    status: 'SCHEDULED', matchTime: '08.30(토) 09:00', closingTime: '08.30(토) 08:50', venue: 'TD 가든',
  ...
  },
  {
    ...
    status: 'SCHEDULED', matchTime: '08.30(토) 21:30', closingTime: '08.30(토) 21:20', venue: '토트넘 홋스퍼 스타디움',
  ...
  },
  {
    ...
    status: 'SCHEDULED', matchTime: '08.30(토) 14:00', closingTime: '08.30(토) 13:50', venue: '인천 계양체육관',
  ...
  },
  {
    ...
    status: 'SCHEDULED', matchTime: '08.30(토) 16:00', closingTime: '08.30(토) 15:50', venue: '원주 종합체육관',
